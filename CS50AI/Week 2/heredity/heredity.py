...
def normalize(probabilities):
    ...
    """
    for person in probabilities:
        # got person as eg harry
        for category in probabilities[person]:
            # got category as  gene
            sum = 0
            for gene_type in probabilities[person][category]:
                sum += probabilities[person][category][gene_type]
            for gene_type in probabilities[person][category]:
                probabilities[person][category][gene_type] /= sum
